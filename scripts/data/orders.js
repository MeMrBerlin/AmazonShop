...
export class OrderList {
  ...
  createNewOrder(cart) {
    ...
    const taxCents =
      (productCostCents + shippingCostCents) * MoneyUtils.taxRate;
            ...
            products: [
              {
                ...
                estimatedDeliveryTimeMs:
                  deliveryOptions
                    .findById("6e2dd65a-6665-4f24-bcdc-f2ecdbc6e156")
                    .calculateDeliveryDate() -
                  1000 * 60 * 60 * 5,
              },
              {
                ...
                estimatedDeliveryTimeMs:
                  deliveryOptions
                    .findById("f297d333-a5c4-452f-840b-15a662257b3f")
                    .calculateDeliveryDate() -
                  1000 * 60 * 60 * 5,
              },
            ],
